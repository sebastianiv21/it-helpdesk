...
const DocuPDF = ({ poema }) => {
  ...
  Font.register({ family: 'Poppins', src:'https://fonts.gstatic.com/s/poppins/v20/pxiEyp8kv8JHgFVrJJbecmNE.woff2' });
  // Font.register({
  //   family: 'Roboto',
...
page: {
  ...
  <View
    ...
    >
<Text style={{color: '#004643', fontSize: '30px', fontWeight: 'bold'}}> IT TECHNOLOGY</Text>
<Text style={{color: '#004643', fontSize: '15px', paddingLeft: '4', paddingBottom:'4'}}> HelpDesk</Text>
      </View>
        <View
      style={{
        display: "flex",
    ...
    <View style={styles.primera}>
       <View
      style={styles.carta}>
      <Text style={{fontSize: '15px', fontWeight: 'bold',color:'#004643',textAlign:'center'}}>Cerrados </Text>
      <Text style={{textAlign:'center', fontSize: '25px', fontWeight: 'bold',color:'#004643', paddingTop: 5,}}>5 </Text>
      </View>
      <View
      style={styles.carta}>
      <Text style={{ fontSize: '15px', fontWeight: 'bold',color:'#004643',textAlign:'center'}}>Abiertos </Text>
      <Text style={{textAlign:'center', fontSize: '25px',color:'#004643',fontWeight: 'bold',paddingTop: 5,}}>5 </Text>
      </View>
    </View>
    <View
    style={styles.tabla} >
...
<Text style={{textAlign:'center', fontSize: '20px', fontWeight: 'bold',color:'#004643',}}>Descripción </Text>
<Text style={{textAlign:'center', fontSize: '20px', fontWeight: 'bold',color:'#004643', paddingTop: 30, }}>ASDADSADDASDSADSDASDDASASASDASDADADASDASDSADADSADADASDADSASDSADASDA  </Text>
</View>
<View style={styles.descripcion}  >
